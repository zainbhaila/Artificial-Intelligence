...
data = datasets.make_classification(n_samples=2500, n_features=4, n_informative=2, n_redundant=2)
X = data[0]
y = np.expand_dims(data[1], 1)
...
data = datasets.make_blobs(n_samples=2500, n_features=4, centers=2)
X = data[0]
y = np.expand_dims(data[1], 1)
