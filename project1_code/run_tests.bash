...
#
#python= C:/Users/Zain\ Bhaila/AppData/Local/Programs/Python/Python37-32/python
...
do
  ...
  do
    ...
    do
        ...
        C:/Users/Zain\ Bhaila/AppData/Local/Programs/Python/Python37-32/python -c "$setup; $run_prog"
        ...
        if [ "$time_tests" = 1 ]; then
            ...
            C:/Users/Zain\ Bhaila/AppData/Local/Programs/Python/Python37-32/python -m timeit -s "$setup" "$time_test"
